...
if result:
    for solution in result:
        P_O2_val = solution[P_O2]
        P_O_val = solution[P_O]
        P_N2_val = solution[P_N2]
        P_N_val = solution[P_N]
        P_NO_val = solution[P_NO]
        print('Partial Pressures:')
        print(f'P_O2: {P_O2_val.evalf():.10f}')
        print(f'P_O: {P_O_val.evalf():.10f}')
        print(f'P_N2: {P_N2_val.evalf():.10f}')
        print(f'P_N: {P_N_val.evalf():.10f}')
        print(f'P_NO: {P_NO_val.evalf():.10f}')
else:
