...
#P5 from chart
# Don't need state 2 to get state 5 relationships, you use chart or data to guess State 5.

print( " - EQ Forced State 5 Values - "*3)

P_5 = 1.64e6 #Mpa
gamma_5 = 1.2865 #Ratio
rho_5 = 3.05 #m^3/kg
T_5 = 1855 #K
...
print()
print( " - Plate Properties from Exp Forced State 5 Values - "*3)
