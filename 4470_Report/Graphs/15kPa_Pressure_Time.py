...
# plt.title('Inferred Pressure Distribution 15 Kpa', weight='bold', fontsize=10)
# plt.legend(fontsize=8)
#
#
# # Set x and y limits to focus on specific intervals
# plt.xlim(left=0.015, right=0.08)
...
# #
# # plt.savefig("Chart.png", format='png', dpi=500)
# plt.show()
#
# PST1
# def Calib15_1(P1,V):
#     return P1 + 1028.744198 * V
#
# PST2
# def Calib15_2(P1,P5):
...
P1 = 15  # Resting pressure is already in kPa

# Calibration functions
def Calib15_1(V):
    return P1 + 1028.744198 * V  # Calibration for p_st1

def Calib15_2(V):
    return P1 + 964.6764 * V     # Calibration for p_st2

# Apply calibration to convert voltage to pressure in kPa
pressure_st1 = Calib15_1(p_st1)
pressure_st2 = Calib15_2(p_st2)
...
plt.title('Calibrated Pressure Distribution at 15 kPa', weight='bold', fontsize=10)
plt.legend(fontsize=8)
...
plt.savefig("15kPa_Pressure_Time_large.png", format='png', dpi=500)
plt.show()
