...
print(f"P_2 is {P_2/1000:.4f} kPa")

M_1_value = find_mach_from_pressure_ratio(P2_P1, gamma_1, 2)
M_1 = M_1_value[0]
print(f"Mach number of P2/P1 is {M_1:.4f}")

U_s = Shock_velocity(a_1,gamma_1, P_2, P_1)
print(f"Shock Speed U_s {U_s:.4f} m/s ")
...
print(f"EQN of 15 kPa system is {Tailoring15kpa:.4f}")
...
print(f"Exit Pressure P_e is {P_e:.4f} Pa")
...
print(f"Exit Temperature T_e is {T_e:.4f} K")
...
print(f"The T_2_oblique from exit T_e is {T_2_obl:.4f} K")
