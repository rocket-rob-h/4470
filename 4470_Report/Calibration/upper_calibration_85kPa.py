...
time_range = (0.02028, 0.02052)  # Adjust this to the time range you are interested in
...
plt.xlim(left=0.0199, right=0.0215)
...
plt.title('Pressure Two Calibration Zone 85 kPa')
plt.legend()
plt.show()
