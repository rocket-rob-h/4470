...
plt.title('Shock velocity determination 15 Kpa', weight='bold', fontsize=10)
plt.legend(fontsize=8)


# Set x and y limits to focus on specific intervals
plt.xlim(left=0.01915, right=0.0194)
plt.ylim(bottom=-0.05, top=0.3)
...
plt.savefig("Shock velocity determination 15 Kpa.png", format='png', dpi=500)
plt.show()